...
--   • Times are written in UTC — the same timezone the app displays — so the
--     wall-clock time below is exactly what shows on screen (19:30 → 7:30 pm).
...
values
  ('Malahide Padel Club',      'Malahide',           ((current_date + 0) + time '19:30') at time zone 'UTC', 'Intermediate', 4, 3),
  ('Swords Padel Arena',       'Swords',             ((current_date + 1) + time '10:00') at time zone 'UTC', 'Beginner',     4, 1),
  ('The Padel Yard',           'Dublin City Centre', ((current_date + 1) + time '18:30') at time zone 'UTC', 'Advanced',     4, 2),
  ('Dún Laoghaire Padel Club', 'Dún Laoghaire',      ((current_date + 2) + time '11:00') at time zone 'UTC', 'Intermediate', 4, 2),
  ('Clontarf Padel Centre',    'Clontarf',           ((current_date + 4) + time '19:00') at time zone 'UTC', 'Beginner',     4, 1),
  ('Sandyford Padel Club',     'Sandyford',          ((current_date + 6) + time '20:00') at time zone 'UTC', 'Advanced',     4, 3);
