"use client";
// Runs in the browser. The sign-up screen: email + password to create a new
// account, then sends the user to the home page once they're in.
...
export default function SignupPage() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    if (data.session) {
      // (a) The account is active straight away — send them to the home page.
      router.push("/");
    } else {
      // (b) Supabase is set to require email confirmation first. Tell them to
      //     check their inbox; they can log in after confirming.
      setNotice(
